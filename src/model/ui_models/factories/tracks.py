...
def get_programs(track):
    programs = {
        ...
        web_track:[Program('Building a Web App 101', 'Aug 1 2015', 20, web_track, 'Learn about writing D.R.Y web code and the limitations of HTML and CSS in achieving that', 'full_stack', None),
                   Program('Going beyond HTML and CSS', 'Aug 1 2015', 20, web_track, 'Learn about writing D.R.Y web code and the limitations of HTML and CSS in achieving that', 'full_stack', None),
                   Program('Discrete Mathematics for hackers', 'Aug 1 2015', 20, web_track, 'Learn about writing D.R.Y web code and the limitations of HTML and CSS in achieving that', 'full_stack', None),
                   Program('Continuous Mathematics for hackers', 'Aug 1 2015', 20, web_track, 'Learn about writing D.R.Y web code and the limitations of HTML and CSS in achieving that', 'full_stack', None),
                   Program('Algorithms and Datastructures revisited', 'Aug 1 2015', 20, web_track, 'Learn about writing D.R.Y web code and the limitations of HTML and CSS in achieving that', 'full_stack', None),
                   Program('Distributed computing', 'Aug 1 2015', 20, web_track, 'Why is CSS pre-compilation necessary and how does it help make CSS modular and D.R.Y', 'full_stack', None),
                   Program('Non-relational Databases', 'Aug 1 2015', 20, web_track, 'Eliminate deep nested HTML and learn to cut down the HTML code you write by half through pre-compilation', 'full_stack', None),
                   Program('NLP 101', 'Aug 1 2015', 20, web_track, 'Explore 2 different types of backend infrastructure. One DEVOPS intensive and one without DEVOPS.', 'full_stack', None),
                   Program('Big Data 101', 'Aug 1 2015', 20, web_track, 'Explore 2 different types of backend infrastructure. One DEVOPS intensive and one without DEVOPS.', 'full_stack', None)],
