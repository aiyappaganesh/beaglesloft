    ...
    programs = {
        mobile_track:
            [
                ...
                Program('Android Programming 101', 'Sep 5 2015', 20, mobile_track, 'Build an iOS App from scratch with a deep dive into iOS Programming.', 'android_programming', get_modules_for(mobile_track)),
                Program('Building an Android App', 'Sep 12 2015', 20, mobile_track, 'Build an iOS App from scratch with a deep dive into iOS Programming.', 'building_an_android_app', get_modules_for(mobile_track)),
                Program('High quality Android code', 'Sep 19 2015', 25, mobile_track, 'Build an iOS App from scratch with a deep dive into iOS Programming.', 'android_coding', get_modules_for(mobile_track)),
                Program('Android App Analytics and Audience Engagement', 'Sep 26 2015', 20, mobile_track, 'Build an iOS App from scratch with a deep dive into iOS Programming.', 'analytics', get_modules_for(mobile_track)),
        ...
        web_track:[Program('Building a Web App 101', 'Aug 2 2015', 20, web_track, 'A beginner course to understand all the skills required to be a good web developer.', 'full_stack', get_modules_for(web_track)),
                   ...
                   Program('Distributed computing', 'Sep 7 2015', 25, web_track, 'Basic concepts of distributed computing and how to execute it on the cloud.', 'dist', get_modules_for(distributed_computing)),
        ...
        designer:[
                ...
                Program('Responsive Design', 'Sep 3 2015', 20, designer, 'Learn how to make your website render seamlessly across a multitude of devices and resolutions.', 'responsive_design', None),
        ...
        product_manager:[
            ...
            Program('Client Management', 'Sep 1 2015', 20, product_manager, 'Learn all the tricks of the trade to develop a long lasting and happy relationship with your clients.', 'client_managament', None),
            Program('Lean Product Management', 'Sep 8 2015', 15, product_manager, 'Learn to work in iterations to build, measure and learn only what is required and save valuable resources.', 'product_management', None)
            ],
        founder: [
